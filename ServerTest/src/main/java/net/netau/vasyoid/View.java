...
public class View extends Application {
    ...
    private void createElements(VBox pane) {
        ...
        architectureChooser.getSelectionModel().selectedIndexProperty().addListener(
        ...
        Spinner minValueChooser = new Spinner(100, 800, 100, 100);
